...
/// see wlr_output_effective_resolution().
///
...
public class OutputLayout {
    ...
    /// Add the output to the layout as automatically configured. This will place the output in a
    /// sensible location in the layout. The coordinates of the output in the layout will be
    /// adjusted dynamically when the layout changes. If the output is already a part of the layout,
    /// it will become automatically configured.
    ///
